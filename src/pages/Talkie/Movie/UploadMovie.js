        ...
        <SafeAreaView style={{}}>
            <ScrollView>
                <HomeHeaderRoundBottom height={80} paddingHorizontal={15} backgroundColor={'#FFD037'}
                    ...
                    press2={() => { }} title2={'Upload Movie'} fontWeight={'500'} img2height={20} color={'#fff'} fontSize={14}
                ...
                <View style={{ width: '90%', alignSelf: 'center' }}>
                    ...
                    <TouchableOpacity style={styles.uploadButtonView} onPress={() => { openLibrary() }}>
                        ...
                        <Text style={{ fontSize: 14, fontWeight: '500', color: '#263238', marginLeft: 10 }}>Upload Movie</Text>
                    </TouchableOpacity>
