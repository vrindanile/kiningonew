...
const ShopEntertainment = (props) => {
  ...
  const homePageSearch = async () => {
    ...
    setLoading(false)
    console.log('the res==>>Home ?name=', responseJson.body.vendors)
    if (responseJson.headers.success == 1) {
  ...
  return (
    <SafeAreaView style={{}}>
      ...
      >
        ...
        <View style={{ width: '96%', alignSelf: 'center' }}>
          ...
          <TouchableOpacity style={{ width: '98%', height: 50, borderRadius: 10, backgroundColor: '#fff', flexDirection: 'row', alignItems: 'center', alignSelf: 'center', marginTop: 10, justifyContent: "space-between" }}
            onPress={() => { props.navigation.navigate('EntertainmentSearch', { datas: [], from: 'search' }) }}>
          ...
          <View style={{ width: '100%', alignSelf: 'center', marginTop: 15 }}>
            {console.log('resdara coupsnnnnnn----->>>>', resData)}
                  ...
                  return (
                    <View style={{ width: dimensions.SCREEN_WIDTH * 75 / 100, marginHorizontal: 5, borderRadius: 10 }}>
                      <TouchableOpacity style={{ width: '100%', height: 120, backgroundColor: Mycolors.LogininputBox, alignSelf: 'center', alignSelf: 'center' }}
                        onPress={() => { props.navigation.navigate('ExploreViewMore', { datas: [], from: '' }) }}>
          ...
          <View style={{ width: '95%', flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', marginTop: 30 }}>
            ...
            {resData?.vendors?.length > 0 ?
              <Text style={{ color: Mycolors.RED, fontWeight: '500', textDecorationLine: "underline", fontSize: 14, }}
                onPress={() => { props.navigation.navigate('ExploreViewMore', { datas: [], from: 'search' }) }}>View More</Text>
              : null}
          </View>
                    ...
                    <View style={{
                      ...
                      <TouchableOpacity style={{ width: "100%", height: 130, backgroundColor: Mycolors.LogininputBox, alignSelf: 'center', padding: 1 }}
                        onPress={() => {
                          ...
                          props.navigation.navigate('EventList', { data: item })
                        }}>
                        <Image source={{ uri: item.banner_image }} style={{ width: '100%', height: '100%', alignSelf: 'center', borderRadius: 8, resizeMode: 'stretch' }}></Image>
                      </TouchableOpacity>
                      <View style={{ left: 9 }}>
                        <Text style={{ fontSize: 12, color: Mycolors.Black, marginTop: 2, fontWeight: 'bold', left: 2 }}>{item.name}</Text>
                        <Text style={{ fontSize: 12, color: '#9B9B9B', marginTop: 2, fontWeight: '500', left: 2, fontStyle: 'italic', }}>{item.address_line}</Text>
                      </View>
                      <View style={{ padding: 5, left: 5, top: -3 }}>
                        <View style={{ flexDirection: 'row', }}>
                          {item.rating != null ?
      ...
      elevation: 5,}}>
          ...
          <View style={{ width: '95%', flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', marginTop: 30 }}>
            ...
            <Text style={{ color: Mycolors.RED, fontWeight: '500', textDecorationLine: "underline", fontSize: 14, top: 10 }}
              onPress={() => { props.navigation.navigate('AllCategories', { datas: resData.categories, from: '' }) }}>View More</Text>
          </View>
                    ...
                    <View style={{ width: 140, height: 200, marginHorizontal: 0, marginVertical: 5, }}>
                      <ImageBackground source={require('../../../assets/Food-Cover-image.png')} style={{ width: '100%', height: '95%', borderRadius: 10, }} resizeMode='cover'>
                        <TouchableOpacity style={{
                          ...
                          <Text style={{ color: Mycolors.Black, fontWeight: '600', fontSize: 12, textAlign: 'center', marginTop: 9 }} >{item.name}</Text>
      ...
      <View style={{ width: '100%', height: 60, flexDirection: 'row', justifyContent: 'space-between', position: 'absolute', bottom: 0, alignSelf: 'center', backgroundColor: '#fff', height: 80, paddingHorizontal: '3%' }}>
        <View style={{ width: '47%' }}>
          {/* <MyButtons title="Dining & Booked Table" height={45} width={'100%'} borderRadius={10} alignSelf="center" press={() => {
             ()=>{props.navigation.navigate('ShopEntPurchasedTickets')}
             }} marginHorizontal={20} fontSize={11}
            titlecolor={Mycolors.BG_COLOR} backgroundColor={Mycolors.ServiceHeader} /> */}
          <MyButtons title="Purchased Tickets" height={45} width={'100%'} borderRadius={10} alignSelf="center" press={() => { props.navigation.navigate('ShopEntPurchasedTickets') }} fontSize={11}
            titlecolor={Mycolors.BG_COLOR} backgroundColor={'#1689CE'} />

        </View>

        <View style={{ width: '47%' }}>
          <MyButtons title="Cancled Tickets" height={45} width={'100%'} borderRadius={10} alignSelf="center" press={() => { props.navigation.navigate('ShopEntPurchasedTickets') }} marginHorizontal={20} fontSize={11}
