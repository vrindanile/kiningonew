  ...
  return (
    ...
    <View style={{
      ...
      <View style={{ width: '100%', height: 45, backgroundColor: Mycolors.BG_COLOR, borderRadius: 8 }}>
        ...
        <View style={{
          width: '84%', height: 45, borderRadius: 8, backgroundColor: Mycolors.LogininputBox, flexDirection: 'row', justifyContent: 'space-between'
          //  shadowColor: '#000',
          //  shadowOffset: {
          //    width: 0,
          //    height: 3
          ...
          />
          <View style={{ width: '14%', height: 45, backgroundColor: 'transparent', borderRadius: 8, }}>
